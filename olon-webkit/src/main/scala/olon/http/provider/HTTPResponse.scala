...
trait HTTPResponse {
  ...
  /** Encodes the URL such that it adds the session ID if it is necessary to the
    * URL. It is implementation specific detail how/if to add the session
    * informations. This will be used for URL rewriting purposes.
    *
    * @param url
  ...
  /** @return
    *   \- the OutputStream that can be used to send down o the client the
    *   response body.
    */
