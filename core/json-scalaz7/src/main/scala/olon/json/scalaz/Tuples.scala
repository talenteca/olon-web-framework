...
trait Tuples { this: Types =>
  implicit def Tuple2JSON[A: JSON, B: JSON]: JSON[(A, B)] = new JSON[(A, B)] {
    ...
    def write(value: (A, B)) = JArray(
      toJSON(value._1) :: toJSON(value._2) :: Nil
    )
  }
  ...
  implicit def Tuple3JSON[A: JSON, B: JSON, C: JSON]: JSON[(A, B, C)] =
    new JSON[(A, B, C)] {
      def read(json: JValue) = json match {
        case JArray(a :: b :: c :: _) =>
          (fromJSON[A](a) |@| fromJSON[B](b) |@| fromJSON[C](c)) { (a, b, c) =>
            (a, b, c)
          }
        case x =>
      ...
      def write(value: (A, B, C)) = JArray(
        toJSON(value._1) :: toJSON(value._2) :: toJSON(value._3) :: Nil
      )
    }
  ...
  implicit def Tuple5JSON[A: JSON, B: JSON, C: JSON, D: JSON, E: JSON]
    ...
    def read(json: JValue) = json match {
      case JArray(a :: b :: c :: d :: e :: _) =>
        (fromJSON[A](a) |@| fromJSON[B](b) |@| fromJSON[C](c) |@| fromJSON[D](
          d
        ) |@| fromJSON[E](e)) { (a, b, c, d, e) => (a, b, c, d, e) }
      case x => failure(UnexpectedJSONError(x, classOf[JArray])).toValidationNel
    }
  ...
  implicit def Tuple6JSON[A: JSON, B: JSON, C: JSON, D: JSON, E: JSON, F: JSON]
    ...
    def read(json: JValue) = json match {
      case JArray(a :: b :: c :: d :: e :: f :: _) =>
        (fromJSON[A](a) |@| fromJSON[B](b) |@| fromJSON[C](c) |@| fromJSON[D](
          d
        ) |@| fromJSON[E](e) |@| fromJSON[F](f)) { (a, b, c, d, e, f) =>
          (a, b, c, d, e, f)
        }
      case x => failure(UnexpectedJSONError(x, classOf[JArray])).toValidationNel
    }
