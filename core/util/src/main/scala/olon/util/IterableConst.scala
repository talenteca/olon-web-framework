...
/** A trait that has some helpful implicit conversions from Iterable[NodeSeq],
  * Seq[String], Box[String], and Option[String]
  */
trait IterableConst {
...
/** The companion object that does the helpful promotion of common collection
  * types into an IterableConst, e.g. Iterable[NodeSeq], Seq[String],
  * Box[String], and Option[String]
  */
object IterableConst {

  /** Converts anything that can be converted into an Iterable[NodeSeq] into an
    * IterableConst. This includes Seq[NodeSeq]
    */
  ...
  /** Converts anything that can be converted into an Iterable[NodeSeq] into an
    * IterableConst. This includes Seq[NodeSeq], Option[NodeSeq], and
    * Box[NodeSeq]
    */
  ...
  implicit def optionNodeSeqFunc(
      it: Option[NodeSeq => NodeSeq]
  ): IterableConst =
