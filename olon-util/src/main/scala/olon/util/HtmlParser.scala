...
/** A utility that supports parsing of HTML5 file. The Parser hooks up
  * nu.validator.htmlparser to
  */
trait Html5Parser {

  /** Parse an InputStream as HTML5. A Full(Elem) will be returned on successful
    * parsing, otherwise a Failure.
    */
