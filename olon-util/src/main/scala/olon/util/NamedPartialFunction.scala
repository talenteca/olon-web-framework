...
/** This trait is used to represent a PartialFunction with additional associated
  * metadata, a name that allows the NamedPartialFunction to be looked up
  * dynamically.
  */
...
object NamedPF {
  ...
  /** Find the first partial function in the specified sequence that is defined
    * at the given value.
    *
    * @param value
  ...
  def find[A, B](
      value: A,
      lst: Seq[PartialFunction[A, B]]
  ): Box[PartialFunction[A, B]] = lst.find(_.isDefinedAt(value))

  /** Determine whether any PartialFunction in the specified sequence is defined
  ...
  /** Find the first PartialFunction in the specified sequence that is defined
    * at the specified value, apply it to that value and return the result or
    * throw a MatchError on failure to find such a function.
    *
    * @param value
    *   the value to use to test each PartialFunction
    * @param lst
  ...
  /** Find the first PartialFunction in the specified sequence that is defined
    * at the specified value, apply it to that value and return the result in a
    * Full Box if found; return Empty otherwise
    *
    * @param value
    *   the value to use to test each PartialFunction
    * @param lst
    ...
    *   <code>value</code>
    * @return
    *   a Full Box containing the result of applying the first PartialFunction
    *   which is defined at the specified value to that value, or Empty if no
    *   such PartialFunction is found
    */
