...
import olon.common.{Box, Empty, Full}
import olon.http.S.SFuncHolder
import olon.http.{LiftSession, Req, RewriteRequest, RewriteResponse, S}
import olon.proto.Crudify
import olon.util.{BaseField, FieldError, FieldIdentifier, LiftValue}

import scala.collection.mutable
import scala.xml._

/**
  * Helper type represents content for [[olon.proto.Crudify]]
  *
...
/** Helper object for [[olon.proto.Crudify]] trait testing */
object SpecCrudType {
  /** [[olon.proto.Crudify.FieldPointerType]] */
...
/**
  * Helper type witch should be used as [[olon.proto.Crudify.FieldPointerType]]
  *
...
/**
  * Helper class for creating fake data repository for using as [[olon.proto.Crudify.CrudBridge]] and for others
  * methods needed by [[olon.proto.Crudify]] implementation
  *
...
/** Spec class implementation of [[olon.proto.Crudify]] trait */
