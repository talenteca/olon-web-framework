 ...
 * @see olon.http.S#error(String,String)
 * @see olon.http.S#error(String,NodeSeq)
 * @see olon.http.LiftRules#noticesEffects
 */
object Msg extends DispatchSnippet {
   ...
   *
   * @see olon.builtin.snippet.Msgs#effects[T](Box[NoticeType.Value],String,T,Box[JsCmd => T])
   */
