...
object CSS extends DispatchSnippet {
  ...
  /** Add
    *
    * <pre name="code" class="xml"> &lt;style
    * class="lift:CSS.blueprint"></style> </pre>
    *
    * to your template and Lift will replace it with the path to the blueprint
    * css styles (screen and print media)
    */
  ...
  /** Add
    *
    * <pre name="code" class="xml"> &lt;style
    * class="lift:CSS.fancyType"></style> </pre>
    *
    * to your template and Lift will replace it with the path to the blueprint
    * fancy-type plugin css styles (screen media)
    */
