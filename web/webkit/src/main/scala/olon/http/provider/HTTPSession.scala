...
trait HTTPSession {
  ...
  /** The opposite of the <i>link</i>. Hence the LiftSession and the HTTP
    * session no longer needs to be related. It is called when LiftSession is
    * explicitelly terminated.
    *
    * @param liftSession
    *   \- the LiftSession
    */
  ...
  /** @return
    *   \- the maximim interval in seconds between client request and the time
    *   when the session will be terminated
    */
  def maxInactiveInterval: Long

  /** Sets the maximim interval in seconds between client request and the time
    * when the session will be terminated
    *
    * @param interval
